...
public class Player extends Object {
    ...
    private boolean checkAlive(){
        ...
        if(tile.contains(Element.SUPMUW) && isNeighborOfWumpus(tile)){
            return false;
        }
        if(tile.contains(Element.PIT) && !tile.contains(Element.SUPMUW)){
            return false;
        }
    ...
    private boolean isNeighborOfWumpus(Tile tile) {
    ...
    protected void setPerceptions() {
        ...
        perceptions.addAll(addPerceptionsForSupmuw());
    }
    ...
    public boolean hasMoo(){
        return perceptions.contains(Perception.MOO);
    }
